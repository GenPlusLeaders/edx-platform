...
######################### GENPLUS SETTINGS #################################
GENPLUS_FRONTEND_URL = ENV_TOKENS.get(
    'GENPLUS_FRONTEND_URL',
    GENPLUS_FRONTEND_URL
)

PROGRAM_ENROLLMENT_COUNTDOWN = ENV_TOKENS.get(
    'PROGRAM_ENROLLMENT_COUNTDOWN',
    PROGRAM_ENROLLMENT_COUNTDOWN
)

TP_LOGOUT_REDIRECT_URL = ENV_TOKENS.get(
    'TP_LOGOUT_REDIRECT_URL',
    TP_LOGOUT_REDIRECT_URL
)

DISABLE_ACCORDION = ENV_TOKENS.get(
    'DISABLE_ACCORDION',
    DISABLE_ACCORDION
)

GENPLUS_GOOGLE_ANALYTICS_ID = ENV_TOKENS.get('GENPLUS_GOOGLE_ANALYTICS_ID', GENPLUS_GOOGLE_ANALYTICS_ID)

BADGR_USERNAME = ENV_TOKENS.get('BADGR_USERNAME', BADGR_USERNAME)
BADGR_PASSWORD = ENV_TOKENS.get('BADGR_PASSWORD', BADGR_PASSWORD)
BADGR_TOKENS_CACHE_KEY = ENV_TOKENS.get('BADGR_TOKENS_CACHE_KEY', BADGR_TOKENS_CACHE_KEY)
...
# RM_UNIFY
RM_UNIFY_KEY = ENV_TOKENS.get('RM_UNIFY_KEY', RM_UNIFY_KEY)
RM_UNIFY_SECRET = ENV_TOKENS.get('RM_UNIFY_SECRET', RM_UNIFY_SECRET)
RM_UNIFY_URL = ENV_TOKENS.get('RM_UNIFY_URL', RM_UNIFY_URL)

HUBSPOT_ACCESS_TOKEN = ENV_TOKENS.get('HUBSPOT_ACCESS_TOKEN', HUBSPOT_ACCESS_TOKEN)
