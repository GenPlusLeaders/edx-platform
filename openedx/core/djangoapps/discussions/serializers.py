...
from lms.djangoapps.discussion.toggles import REPORTED_CONTENT_EMAIL_NOTIFICATIONS_FLAG
    ...
    def to_representation(self, instance: CourseDiscussionSettings) -> dict:
        ...
        payload = {
            ...
            'reported_content_email_notifications_flag':
                REPORTED_CONTENT_EMAIL_NOTIFICATIONS_FLAG.is_enabled(course_key),
        }
        return payload
