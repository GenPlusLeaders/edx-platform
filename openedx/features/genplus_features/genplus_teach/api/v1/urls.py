...
from .views import ArticleViewSet, ReflectionAnswerViewSet, ArticleViewLogViewSet
...
urlpatterns = (
    ...
    url(r'^reflections/(?P<reflection_id>\d+)/answer/', ReflectionAnswerViewSet.as_view({"put": "answer"})),
